...
class HADropDown: UIView {
    ...
    override func prepareForInterfaceBuilder() {
        label.frame = CGRect(x: 0, y: 0, width: self.frame.width, height: self.frame.height)
        font = UIFont.robotoMedium(titleFontSize)
        label.font = font
    ...
    override func layoutSubviews() {
        ...
        table.separatorColor = UIColor.necktieBackground
    ...
    @objc private func didTap(gesture: UIGestureRecognizer) {
        ...
        if !isCollapsed {
            ...
            self.table.layer.borderColor = UIColor.clear.cgColor
            ...
            UIView.animate(withDuration: 0.25, animations: {
                self.table.frame = CGRect(x: self.tableFrame.origin.x, y: self.tableFrame.origin.y + self.frame.height+5, width: self.frame.width, height: height+8)
            })
...
extension HADropDown : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let font = UIFont.roboto(12)
        cell?.textLabel?.font = font
        
        cell?.textLabel?.textColor = UIColor.darkGray
        
        cell?.tintColor = UIColor.necktieGradientEnd
